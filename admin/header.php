...
<body style="background-color:pink">
    <div class="wrapper">
                    ...
                    <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                        <li class="nav-item dropdown hidden-caret">
                            <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
                                <div class="avatar-sm">
                                    <img src="../assets/img/rumahlaundry.jpg" alt="..." class="avatar-img rounded-circle">
                                </div>
                            </a>
                            <ul class="dropdown-menu dropdown-user animated fadeIn">
                                <div class="dropdown-user-scroll scrollbar-outer">
                                    <li>
                                        <div class="user-box">
                                            <div class="avatar-lg"><img src="../assets/img/rumahlaundry.jpg" alt="image profile" class="avatar-img rounded"></div>
                                            <div class="u-text">
        ...
        <div class="sidebar sidebar-style-2" style="background-color:lightskyblue">
            <div class="sidebar-wrapper scrollbar scrollbar-inner">
                <div class="sidebar-content">
                    ...
                    <ul class="nav nav-primary">
                        <li class="nav-item <?php if ($title == 'Selamat Datang di Solusi Laindry,Rapi dan Wangi Tahan lama') {
                                                echo 'active';
                                            } ?>">
