<?php
$title = 'Selamat Datang di Aplikasi Laundry Woi';
require 'koneksi.php';
require 'header.php';
    ...
    <div class="page-inner py-5">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
            <div>
                ...
                <h2 class="text-white op-7 mb-2">Malaslah mencuci,karena mencuci adalah tugas kami</h2>
            </div>
        </div>
    </div>
</div>
<div class="page-inner mt--5">
    <div class="row">
        <div class="col-sm-6 col-md-3">
            <div class="card card-stats bg-dark" style="border-radius:30px;">
                <div class="card-body ">
